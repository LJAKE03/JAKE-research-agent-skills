...
'@
  return $template.Replace('【用户输入的任务】',$Task).
    ...
    Replace('【economy_agent_type】',[string]$dispatch.economy_agent_type).
    Replace('【fork_turns】',[string]$dispatch.fork_turns).
    Replace('【support_model】',[string]$support.model).
    Replace('【support_effort】',[string]$support.reasoning_effort).
    Replace('【economy_model】',[string]$economy.model).
    Replace('【economy_effort】',[string]$economy.reasoning_effort).
    Replace('【failure_status】',[string]$dispatch.failure_status)
}
