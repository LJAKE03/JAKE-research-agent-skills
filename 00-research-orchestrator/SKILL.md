...
3. 仅在阶段边界、重大异常或项目收尾时记录经验。单项目观察到的工作习惯标记为“待确认”，不得自动升级为稳定偏好。
4. 项目完成前，Sol 核对交付物、质量门、未解决项和敏感信息，完成 `08_质量门与复盘/PROJECT_RETROSPECTIVE.md` 并生成去敏晋升包。
5. 经验总结可以自动生成；只有用户明确批准的跨项目经验才能进入个人全局记忆。公共 Skill 的修改还必须通过独立评审和回归测试。
